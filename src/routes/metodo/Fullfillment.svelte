	...
	<div class="mw grid items-center gap-6 md:grid-cols-2 md:gap-12">
		<section class="mw flex flex-col gap-4 text-lg md:gap-6 md:text-xl">
			...
			<ul class="list-disc pl-6">
				<li>
					Entrega la promesa de valor rápido y sin fricción, reforzando percepción de
					profesionalismo y autoridad.
				</li>
				<li>
					Maximizar Lifetime Value (LTV) y reducir churn automatizando upsells, referidos y
					upgrades.
				</li>
			</ul>
		</section>
		<img src={fourth} alt="Cuarto esquema" />
	</div>
</article>
